    ...
    <section id="projets" className="px-6 py-24">
      <div className="mx-auto max-w-6xl">
        ...
        <div className="mt-10 grid grid-cols-1 gap-6 md:grid-cols-2 lg:grid-cols-3">
          {projets.map((p, i) => (
            <Reveal key={p.titre} delai={(i % 3) * 90} className="h-full">
              <article className="flex h-full flex-col overflow-hidden rounded-2xl border border-gold-500/15 bg-nuit-950/70 transition duration-300 hover:-translate-y-1 hover:border-gold-500/40 hover:shadow-or">
                <div
