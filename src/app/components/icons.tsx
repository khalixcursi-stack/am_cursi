...
export function IconGamepad({ className = "h-5 w-5" }: IconProps) {
  return (
    <svg {...attributs} className={className}>
...
export function IconLaptop({ className = "h-5 w-5" }: IconProps) {
  return (
    <svg {...attributs} className={className}>
      <path d="M20 16V5a2 2 0 0 0-2-2H6a2 2 0 0 0-2 2v11M2 16h20l-1 4H3z" />
    </svg>
  );
}
